...
int bus_scan() {
    ...
    // stdio_init_all();
#if !defined(DEFAULT_I2C) || !defined(DEFAULT_I2C_SDA_PIN) || !defined(DEFAULT_I2C_SCL_PIN)
#warning i2c/bus_scan example requires a board with I2C pins
    puts("Default I2C pins were not defined");
#else
    // This example will use I2C0 on the default SDA and SCL pins (GP4, GP5 on a Pico)
    i2c_init(DEFAULT_I2C, 100 * 1000);
    ...
    bi_decl(bi_2pins_with_func(DEFAULT_I2C_SDA_PIN, DEFAULT_I2C_SCL_PIN, GPIO_FUNC_I2C));
